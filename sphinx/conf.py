# -*- coding: utf-8 -*-
#
# PyQt MDI Image Viewer documentation build configuration file, created by
# sphinx-quickstart on Tue Oct 19 04:24:16 2010.
#
...
latex_documents = [
  ('index', 'PyQtMDIImageViewer.tex', u'PyQt MDI Image Viewer Documentation',
   u'TP', 'manual'),
]
...
man_pages = [
    ('index', 'pyqtmdiimageviewer', u'PyQt MDI Image Viewer Documentation',
     [u'TP'], 1)
]
